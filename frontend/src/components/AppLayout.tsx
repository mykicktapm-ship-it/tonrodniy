import { Box, Flex, HStack, Icon, Text, Button, useColorModeValue, Stack } from '@chakra-ui/react';
  ...
  return (
    <Flex direction="column" minH="100vh">
      ...
      >
        ...
        <Stack direction={{ base: 'column', lg: 'row' }} spacing={{ base: 3, lg: 4 }} align="center">
