...
export const TONCONNECT_MANIFEST_PATH = '/tonconnect-manifest.json';
export const ROUND_WALLET_PLACEHOLDER = 'EQCYMOCKROUNDWALLETSAMPLE0000000000000000000000000000000';
export const MOCK_STAKE_TON = 1.25;
