  ...
  const handleReserveSeat = async () => {
    if (!wallet) {
      toast({
        ...
        description: 'We need a wallet to anchor your seat and stake request.',
        status: 'warning',
      });
    ...
    toast({
      title: 'Seat reserved (mock)',
      description: 'In F3/F4 this will trigger the lobby seat allocation flow.',
      status: 'success',
    });
  };
        ...
        <Grid templateColumns={{ base: '1fr', md: '2fr 1fr' }} gap={6}>
          <GridItem>
            <Stack spacing={4}>
              ...
              <Button alignSelf="flex-start" onClick={handleReserveSeat}>
                Reserve mock seat
              </Button>
            </Stack>
          </GridItem>
